      ...
      <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
        ...
        <div>
          <div className='leading-8 p-2'>
            <h1 className='text-[20px] font-bold '>Sub Category</h1>
            <span >
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                  ...
                  <li>
                    <div class="flex items-center">
                      ...
                      <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Sub Category</a>
                    </div>
                  </li>
        ...
        <div className="flex items-center gap-3">
          ...
          { activeDialog==="add_subcategory" && <AddSubCategory />}
